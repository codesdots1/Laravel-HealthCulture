...
@section('content')
    ...
    <section class="custom-padding blocktext bold" style="height:100%;">
        <div class="container">
            <div class="">
                <div class="row allscreen-custom-height">
                    <div class="col-md-6 col-12 m-auto pr-custom pt-md-0 pt-5">
                        <div class="p-3">
                            <form id="file-upload-form" class="uploader" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input id="thumbnail_video" type="file" name="thumbnail_video" style="opacity: 0;" accept="video/mp4,video/x-m4v,video/*"/>

                                <div class="row" id="maincustom-ProgressBar" style="margin-bottom:-3%;">
                                    <div class="col-6 mt-2">
                                        <span class="heavy badge custom-badge bg-primary text-white m-0">ON DEMAND</span>
                                    </div>

                                    {{-- <div class="col-6 d-none mb-0 mt-2" id="custom-ProgressBar" style="width: 48% !important; background: #ACBACA;padding: 9px; border-radius: 6px; z-index: 9;">
                                        <div id="uploadVideoProgressBar" style="height: 5px; width: 1%; background: #2781e9;">
                                            <div id="ProgressBarPercentage" class="mb-0"></div>
                                        </div>
                                    </div> --}}

                                    <div class="col-6 d-none mb-0 mt-2 text-center" id="custom-ProgressBar" style="width:48% !important;background:#ACBACA;padding: 9px; border-radius: 6px; z-index: 1;">
                                        <span id="ProgressBarPercentage" class="mb-0"></span>
                                        <div id="uploadVideoProgressBar" style="height: 5px; width: 1%;background: #2781e9;"></div>
                                    </div>
                                </div>

                                <label for="thumbnail_video" id="file-drag" style="margin: 0px;">

                                    <video style="width: 100%;" alt="Preview" id="file-image" class="hidden" controls>
                                        <source id="videoSource"/>
                                    </video>

                                    <div id="start">
                                        <i class="bi bi-cloud-upload" style="font-size: 58px;"></i>
                                        <div>Upload On Demand Video</div>
	    ...
	    <img src="{{ asset('assets/images/red-border.png') }}" style="    height: 100%;" />
                    ...
                    <div class="col-md-5 col-12 m-auto pt-md-0 pt-5 custom-buttom">
                        ...
                        <form id="myForm" class="screen5-form" action="#" method="POST">
                            @csrf
                            <input type="hidden" name="thumbnail_video" id="thumbnail_video">
	...
	<div class="input-group has-feedback" style="margin-bottom: 14px !important;">
                        <div class="input-group has-validation">
                               <select class="form-select " aria-label="Default select example" name="class_type_id" style=" height: 51.5px;"  required>
                                    <option value="">Class Type</option>
                                    @foreach ($class_type as $single)
                                    <option value="{{ $single->id }}">{{ $single->class_type_name }}</option>
                                    @endforeach
                                </select>
	...
	<div class="input-group has-feedback" style="margin-bottom: 14px !important;">
                        <div class="input-group has-validation">
                                <input type="text" name="class_subtitle" class="form-control " id="exampleFormControlInput1" placeholder="Class Subtitle"  style=" height: 51.5px;"  required>
	</div>
	</div>

	<div class="input-group has-feedback" style="margin-bottom: 14px !important;">
                        <div class="input-group has-validation">
                                <select class="form-select" name="class_difficulty_id"aria-label="Default select example"  style=" height: 51.5px;"  required>
                                    <option value="">Class Difficulty</option>
                                    @foreach ($class_difficulty as $single)
                                        <option value="{{ $single->id }}">{{ $single->class_difficulty_name }}</option>
                                    @endforeach
                                </select>
	</div>
	</div>
                        ...
                        <div class="input-group has-validation">
                                    <label class="input-group-prepend" for="duration">
                                        <div class="input-group-text custom-clock-icon">
                                            <i class="bi bi-alarm" style="font-size:21px "></i>
                                        </div>
                                    </label>
	...
	<div class="input-group has-feedback" style="margin-bottom: 14px !important;">
                                <div class="input-group has-validation custom-placeholder-center">
                                    <label class="input-group-prepend" for="subscriber_fee">
                                     
                                        <select class="form-select" name="Nationality" id="nationality1" style="background-color: #526070 !important; border-radius: 8px 0px 0px 8px;width: 70px; font-size: 21px !important; height: 51.5px;">
	...
	<div class="input-group has-feedback" style="margin-bottom: 14px !important;">
                            ...
                            <div class="tab">
                                ...
                                <div class="text-white mb-4  mt-5">
                                    <h4 class="bold" style=" font-size: 26px !important;"><b> Used Muscles </b></h4>
                                </div>

                                <div class="row mb-3">
                                    <div class="col-md-6 col-6 text-end ">
                                        <svg xmlns="http://www.w3.org/2000/svg" style="width:50%;" height="250" viewBox="0 0 90.921 186.555">
                                ...
                                <div class="row custom-Muscles-btn mb-2">
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3 muscle_group_error">
                                        <input type="checkbox" class="btn-check btn-secondary" id="Neck" name="muscle_group_id[]"  value="1" autocomplete="off">
                                        <label class="btn btn-outline-secondary semibold" for="Neck">
                                            <b>Neck</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Shoulders">
                                            <b>Shoulders</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Chest">
                                            <b>Chest</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class=" col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Biceps">
                                            <b>Biceps</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Forearm">
                                            <b>Forearm</b>
                                        </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Abdominals">
                                            <b>Abdominals</b>
                                        </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Oblique">
                                            <b>Oblique</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="UpperBack">
                                            <b>Upper Back</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="LowerBack">
                                            <b>Lower Back</b>
                                        </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Quadriceps">
                                            <b>Quadriceps</b>
                                        </label>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Hamstrings">
                                            <b>Hamstrings</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4 col-6 text-center mb-3">
                                        ...
                                        <label class="btn btn-outline-secondary semibold" for="Calfs">
                                            <b>Calfs</b>
                                        </label>
                                    </div>

                                    <div class=" col-md-6 col-lg-4 col-6 text-center mb-3">
                                        <input type="checkbox" class="btn-check btn-secondary" name="muscle_group_id[]" value="13" id="Glutes" autocomplete="off">
                                        <label class="btn btn-outline-secondary semibold" for="Glutes">
                                            <b>Glutes</b>
                                        </label>
                                    </div>
                            ...
                            <!-- -------------------screen-10------------------- -->
                            <div class="tab">
                                <p class="col-md-5 col-12 custom-buttom mt-5" style="z-index: 1 ;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 d-md-block d-none">
                                        <div class="text-center ">
                                            <div class="text-white">
                                                <h4 style="padding-bottom: 25px;"><b>Burnt Calories</b></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="control-group input-group d-block">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2 col-md-2 col-2 p-0">
                                                            <button class="btn text-white remove-btn remove" type="button"><i class="bi bi-trash-fill"></i>
                                                            </button>
                                                        </div>
                                            ...
                                            <div class="hide p-0">
                                                <div class="control-group input-group d-block">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-10 col-md-10 col-10 ">
                                                            <select class="form-select mb-2 text-center" name="equipment[]" style="    background-color: #444e5a !important;" aria-label="Default select example" required>
                                                                <option selected value="">Equipment</option>
                                                                @foreach ($equipment as $single)
                                                                    <option value="{{ $single->id }}">
                                                                        {{ $single->equipment_name }}
                            ...
                            <div style="overflow:auto;">
                                <div class="pb-md-5 pb-0" style=" margin-top: 5px;">
                                    <button type="button" class="previous">
                                        <i class="bi bi-chevron-left"></i>
                                    </button>
                                    <div class="text-center">
                                        <button type="button" class="next btn btn-danger mt-2 bold" style="padding: 1.5% 24%;">
                                            <b>Next</b>
                                        </button>
                                    </div>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-danger mt-2 submit bold" style="padding: 1.5% 24%;">
                                            <b>Save</b>
                                        </button>
                                    </div>
                                </div>
            ...
            reader.onload = function(e) {
                ...
                setTimeout(function() {
                    ...
                    if (loaded <= total) {
                        ...
                        $('#ProgressBarPercentage').html("Video Upload Complete.");
                    }
                }, 250);
            }
        }
