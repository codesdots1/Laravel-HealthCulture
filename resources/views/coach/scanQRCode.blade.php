...
@section('content')
    ...
    <section class=" blocktext h-100" style="margin-top:78px;">
        <div class="p-4">
            <div class=" ">
	        ...
	        <img src="{{ asset('assets/images/red-border.png') }}" style="width:15px;" />
                    ...
                    <div class="col-lg-7 col-md-12 col-12 custom-buttom pt-4  pb-5   ps-2">
                        ...
                        <ol class="screen3-ol semibold">
                            ...
                            <div class="row mb-5">
                                <li class="ps-md-5 ps-2" style="color: #AFAFAF;">Watch the “On Demand” or “Live” Class. </li>
                            </div>
